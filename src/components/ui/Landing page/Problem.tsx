const Problem = () => 
{
    ...
    return ( 
        <section id="problem" className="py-6 px-6 md:px-12 bg-gray-100 text-gray-800">
            <div className="max-w-6xl mx-auto text-center space-y-5">
                ...
                <p className="text-lg text-gray-600">Despite being a major source of income in many rural areas, tea farming continues to face significant challenges that reduce productivity and profitability.</p>
